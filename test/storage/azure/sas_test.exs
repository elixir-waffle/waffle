defmodule Waffle.Storage.Azure.SASTest do
  use ExUnit.Case, async: true

  alias Waffle.Storage.Azure.SAS

  describe "generate_sas_token/5" do
    test "generates valid SAS token" do
      ...
      sas_token = SAS.generate_sas_token(storage_account, container, blob_name, access_key, expiry_in_seconds)
  ...
  describe "generate_sas_url/5" do
    test "generates complete SAS URL" do
      ...
      {:ok, url} = SAS.generate_sas_url(storage_account, container, blob_name, access_key, expiry_in_seconds)
    ...
    test "handles errors gracefully" do
      ...
      result = SAS.generate_sas_url("account", "container", "blob", "invalid_key", 3600)
